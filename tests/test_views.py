...
from sentry_cas_ng.models import ProxyGrantingTicket, SessionTicket
from sentry_cas_ng.views import CallbackView, LoginView, LogoutView
...
def test_login_authenticate_and_create_user(monkeypatch, django_user_model, settings):
    ...
    settings.AUTHENTICATION_BACKENDS = ['sentry_cas_ng.backends.CASBackend']
