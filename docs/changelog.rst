...
**django-cas-ng 3.6.0** ``[2018-11-23]``
  ...
  * PR-173: Include 'sentry_cas_ng.middleware.CASMiddleware' middleware in example settings of README
...
* Add signal support ``sentry_cas_ng.signals.cas_user_authenticated``
